           ...
           # medi =  msg.document or msg.video or msg.audio or None
            ...
            if str(file).split(".")[-1] in ['mkv', 'mp4', 'webm', 'mpe4', 'mpeg']:
                ...
                await client.send_video(
                    chat_id=sender,
                    video=path,
                    caption=caption.replace(" (", "").replace(")", "").replace("𝚂𝚝𝚞𝚋𝚋𝚘𝚛𝚗.mkv", "").replace("(1280×720)", "").replace("Batch Name : 𝐆𝐒 𝐅𝐨𝐮𝐧𝐝𝐚𝐭𝐢𝐨𝐧 𝐀𝐀𝐑𝐀𝐌𝐁𝐇 𝐁𝐀𝐓𝐂𝐇 𝟐𝟎𝟐𝟒", "**Batch Name :** GK-GS आरंभ Batch 2024 | CrazyGkTricks\n**Join @Rexodas2023 In Case of Copyright**").replace("Downloaded by : 𝐒𝚝𝚞𝚋𝚋𝘰𝚛η💙", "**Downloaded By :** @Rexodas2023"),
