           ...
           # medi =  msg.document or msg.video or msg.audio or None
            ...
            if str(file).split(".")[-1] in ['mkv', 'mp4', 'webm', 'mpe4', 'mpeg']:
                ...
                await client.send_document(
                    sender,
                    path, 
                    caption=caption.replace(" (", "").replace(")", "").replace("Downloaded by : 𝐒𝚝𝚞𝚋𝚋𝘰𝚛η💙", "**Downloaded By :** @RolexEmpire").replace("Batch Name :𝐆𝐒 𝐅𝐨𝐮𝐧𝐝𝐚𝐭𝐢𝐨𝐧 𝐀𝐀𝐑𝐀𝐌𝐁𝐇 𝐁𝐀𝐓𝐂𝐇 𝟐𝟎𝟐𝟒", "**\nBatch Name :** GK-GS आरंभ Batch 2024 | CrazyGkTricks").replace("𝚂𝚝𝚞𝚋𝚋𝚘𝚛𝚗.pdf", "(PDF)").replace("👉", " ").replace("_", " ").replace("Extracted By : @cipherbank", "").replace("Mrjoker.pdf", "PDF").replace("Batch Name :", "**Batch Name : **").replace("➤ 𝐌𝐑 𝐉𝐎𝐊𝐄𝐑 ❤️", "`@Rexodas2023`").replace("Downloaded by : ", "**Provided By : **").replace("Batch Name :𝐒𝐭𝐚𝐭𝐢𝐜 𝐆𝐊 𝟐𝟎𝟐𝟒 𝐅𝐨𝐮𝐧𝐝𝐚𝐭𝐢𝐨𝐧 𝐁𝐚𝐭𝐜𝐡 𝐙𝐞𝐫𝐨 𝐓𝐨 𝐇𝐞𝐫𝐨 𝐋𝐞𝐯𝐞𝐥 𝐅𝐨𝐫 𝐀𝐥𝐥 𝐒𝐒𝐂 𝟐𝟎𝟐𝟒 𝐄𝐱𝐚𝐦 | 𝐁𝐲 𝐒𝐒𝐂 𝐂𝐫𝐚𝐜𝐤𝐞𝐫𝐬 ₹𝟒𝟒𝟗", "").replace("Downloaded by : 𝐒𝚝𝚞𝚋𝚋𝘰𝚛η❤️", "**Join @SSC_HUNTERS For More Exclusive PDFs**"),
                    thumb=thumb_path,
                    progress=progress_for_pyrogram,
                    progress_args=(
                        client,
